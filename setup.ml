(* OASIS_START *)
(* DO NOT EDIT (digest: d775be775bd1effe1149ab7ba0a333c1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2005-2013 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\230\0210)\184\025\002\148\191\194\001\128iz\186W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
