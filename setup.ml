(* OASIS_START *)
(* DO NOT EDIT (digest: 046e0afbc16350218e29336728a37b7f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/type_conv";
          synopsis =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\204\011t@i\251'\144\174L\175\242\227\189\225\244";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
